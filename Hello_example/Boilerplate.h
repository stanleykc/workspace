...
Hello::Basic_MessageDataWriter_var narrow(DDS::DataWriter_var writer);
Hello::Basic_MessageDataReader_var narrow(DDS::DataReader_var reader);
Hello::Basic_MessageDataWriter_var narrow(DDS::DataWriter_ptr writer);
Hello::Basic_MessageDataReader_var narrow(DDS::DataReader_ptr reader);
